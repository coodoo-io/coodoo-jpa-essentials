...
public abstract class AbstractIdOccCreatedAtByEntity extends AbstractCreatedAtByEntity implements IdAnnotated, VersionAnnotated {
    ...
    public String toString() {
        ...
        builder.append("AbstractIdOccCreatedAtByEntity [id=");
        builder.append(id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof AbstractIdOccCreatedAtByEntity)) {
            return false;
        }
        if (getClass() != obj.getClass()) {
            return false;
        }
        if (((AbstractIdOccCreatedAtByEntity) obj).getId() == null) {
            return false;
        }
