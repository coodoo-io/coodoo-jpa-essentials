 ...
 * <br>
 * You can use {@link AbstractIdCreatedUpdatedAtByEntityDTO} instead of {@link AbstractIdCreatedUpdatedDeletedAtByEntityDTO} to hide the {@link #deletedAt}
 * field. <br>
 * <br>
 * 
 * 
...
@MappedSuperclass
public abstract class AbstractIdCreatedUpdatedDeletedAtByEntity extends AbstractCreatedUpdatedDeletedAtByEntity implements IdAnnotated {
    ...
    public String toString() {
        ...
        builder.append("AbstractIdCreatedUpdatedDeletedAtByEntity [id=");
        builder.append(id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof AbstractIdCreatedUpdatedDeletedAtByEntity)) {
            return false;
        }
        if (getClass() != obj.getClass()) {
            return false;
        }
        if (((AbstractIdCreatedUpdatedDeletedAtByEntity) obj).getId() == null) {
            return false;
        }
        return ((AbstractIdCreatedUpdatedDeletedAtByEntity) obj).getId().equals(getId());
    }
