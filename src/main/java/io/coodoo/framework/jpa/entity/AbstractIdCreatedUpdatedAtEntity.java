...
@MappedSuperclass
public abstract class AbstractIdCreatedUpdatedAtEntity extends AbstractCreatedUpdatedAtEntity implements IdAnnotated {
    ...
    public String toString() {
        ...
        builder.append("AbstractIdCreatedUpdatedAtEntity [id=");
        builder.append(id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof AbstractIdCreatedUpdatedAtEntity)) {
            return false;
        }
        if (getClass() != obj.getClass()) {
            return false;
        }
        if (((AbstractIdCreatedUpdatedAtEntity) obj).getId() == null) {
            return false;
        }
        return ((AbstractIdCreatedUpdatedAtEntity) obj).getId().equals(getId());
    }
