...
@MappedSuperclass
public abstract class AbstractIdOccCreatedUpdatedAtEntity extends AbstractCreatedUpdatedAtEntity implements IdAnnotated, VersionAnnotated {
    ...
    public String toString() {
        ...
        builder.append("AbstractIdOccCreatedUpdatedAtEntity [id=");
        builder.append(id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof AbstractIdOccCreatedUpdatedAtEntity)) {
            return false;
        }
        if (getClass() != obj.getClass()) {
            return false;
        }
        if (((AbstractIdOccCreatedUpdatedAtEntity) obj).getId() == null) {
            return false;
        }
        return ((AbstractIdOccCreatedUpdatedAtEntity) obj).getId().equals(getId());
    }
