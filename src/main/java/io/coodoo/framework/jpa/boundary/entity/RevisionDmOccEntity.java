 ...
 * @deprecated use {@link AbstractIdOccCreatedUpdatedDeletedAtByEntity}
 */
@Deprecated
@SuppressWarnings("serial")
@MappedSuperclass
public abstract class RevisionDmOccEntity extends RevisionDmEntity implements VersionAnnotated {
